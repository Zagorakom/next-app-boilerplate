...
const env_BASEPATH_STRING: string = process.env.NEXT_PUBLIC_BASEPATH ? process.env.NEXT_PUBLIC_BASEPATH : '';

export { env_isPROD, env_isDEV, env_MODE, env_RUNTIME, env_API_ROUTE, env_isBROWSER, env_BASEPATH_STRING };
